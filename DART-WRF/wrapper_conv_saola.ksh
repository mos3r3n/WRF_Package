...
export  SCRIPTS_DIR=/share/home/zhaokun/haiqin/scripts/CYCLE_EAKF/New
...
export  OBS_DIR=/share/home/zhaokun/haiqin/data/conv
...
export  OBS_D01_DIR=${EXP_DIR}/obs_d01_conv
export  OBS_D02_DIR=${EXP_DIR}/obs_d02_conv
#wps & real
...
# wrf-related
export  ENS_WRF_DIR=$EXP_DIR/ens_wrf_conv
# analysis process
export  BLEND_DIR=$EXP_DIR/blending
export  DART_D01_DIR=$EXP_DIR/eakf_conv_d01
export  DART_D02_DIR=$EXP_DIR/eakf_conv_d02
#############################################################
...
export EAKF_D02_CORE=120
export EAKF_D02_WALLTIME=45
export WRF_CORE=120
export WRF_WALLTIME=12
